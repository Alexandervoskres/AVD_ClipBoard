...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\miner\PycharmProjects\ADV_ClipBoard\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\miner\PycharmProjects\ADV_ClipBoard\venv\Scripts\deactivate.nu'
